...
class TrafficMetric(_MessageFact, Base):
    ...
    source_profile_id: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
...
class TrackEvent(_MessageFact, Base):
    ...
    association_id: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)
    tracking_method: Mapped[str | None] = mapped_column(String(80), nullable=True)
    tracking_quality: Mapped[str | None] = mapped_column(String(24), nullable=True)
    geo_reference_quality: Mapped[str | None] = mapped_column(String(24), nullable=True)
    road_match_quality: Mapped[str | None] = mapped_column(String(32), nullable=True)
    quality_reasons: Mapped[list | None] = mapped_column(JSON, nullable=True)
    geo_registration_id: Mapped[str | None] = mapped_column(String(40), nullable=True, index=True)
    ...
    yolo_model_id: Mapped[str | None] = mapped_column(String(160), nullable=True)
    class_mapping_version: Mapped[str | None] = mapped_column(String(120), nullable=True)
    ...
    trajectory_enu_m: Mapped[list | None] = mapped_column(JSON, nullable=True)
    trajectory_gcj02: Mapped[list | None] = mapped_column(JSON, nullable=True)
    entry_point_enu_m: Mapped[list | None] = mapped_column(JSON, nullable=True)
    exit_point_enu_m: Mapped[list | None] = mapped_column(JSON, nullable=True)
    ...
    start_road_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    exit_road_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    anchor_gcj02: Mapped[list | None] = mapped_column(JSON, nullable=True)
    map_version_id: Mapped[str | None] = mapped_column(String(40), nullable=True, index=True)
    matched_lane_key: Mapped[str | None] = mapped_column(String(100), nullable=True)
    source_lane_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    matched_link_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    movement_key: Mapped[str | None] = mapped_column(String(120), nullable=True)
    map_match_confidence: Mapped[float | None] = mapped_column(Float, nullable=True)
...
class TrackPoint(_MessageFact, Base):
    ...
    position_gcj02: Mapped[dict | None] = mapped_column(JSON, nullable=True)
...
class ConflictEvent(_MessageFact, Base):
    ...
    motor_position_enu_m: Mapped[list | None] = mapped_column(JSON, nullable=True)
    non_motor_position_enu_m: Mapped[list | None] = mapped_column(JSON, nullable=True)
    conflict_position_gcj02: Mapped[list | None] = mapped_column(JSON, nullable=True)
    anchor_gcj02: Mapped[list | None] = mapped_column(JSON, nullable=True)
    __table_args__ = (
...
class TelemetryMetric(_MessageFact, Base):
    ...
    source_profile_id: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
    position_gcj02: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    coordinate_transform_version: Mapped[str | None] = mapped_column(String(80), nullable=True)
