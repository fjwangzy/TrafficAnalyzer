...
class ReplayV2ConflictEvent(Base):
    ...
    motor_track_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    non_motor_track_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    distance_m: Mapped[float | None] = mapped_column(Float, nullable=True)
    conflict_scene: Mapped[str | None] = mapped_column(String(100), nullable=True)
