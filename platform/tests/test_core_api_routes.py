...
class _Influx:
    ...
    def query_track_events(self, *args, **kwargs):
        return []

    def query_conflict_events(self, intersection_id, period="1h", limit=200):
...
class CoreApiRoutesTest(unittest.TestCase):
    ...
    def test_conflict_history_endpoint_returns_replay_evidence(self):
        ...
        self.assertEqual(
            self.client.app.state.influx.conflict_query_args,
            ("INT_camera_1", "30m", 20),
        )
